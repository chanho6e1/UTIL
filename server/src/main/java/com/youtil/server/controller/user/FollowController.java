...
public class FollowController {
    ...
    @GetMapping("/{toUserId}")
    public ResponseEntity<CommonResponse> find(@ApiIgnore @CurrentUser UserPrincipal user, @PathVariable("toUserId") Long toUserId){
//        System.out.printf("toUserId : " + toUserId + " fromUserId : " + user.getId() );
    ...
    public ResponseEntity<CommonResponse> getFollowing(@ApiIgnore @CurrentUser UserPrincipal user){
        return ResponseEntity.ok().body(CommonResponse.of(
    ...
    @GetMapping("/follower")
    public ResponseEntity<CommonResponse> getFollower(@ApiIgnore @CurrentUser UserPrincipal user){
        return ResponseEntity.ok().body(CommonResponse.of(
