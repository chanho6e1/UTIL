...
//                                                               @RequestParam(value = "size", required = false, defaultValue = "10") int size){
//        return ResponseEntity.ok().body(CommonResponse.of(
//                HttpStatus.OK, "정렬 기준으로 내가 좋아요한 게시물 목록 조회 성공", postService.findByLikePostList(user.getId(), PostSearch.of(content, criteria), offset, size))
//        );
//    }
...
//                                                             @RequestParam(value = "size", required = false, defaultValue = "10") int size){
//        return ResponseEntity.ok().body(CommonResponse.of(
//                HttpStatus.OK, "정렬 기준으로 내가 북마크한 게시물 목록 조회 성공", postService.findByBookmarkPostList(user.getId(), PostSearch.of(content, criteria), offset, size))
//        );
//    }
