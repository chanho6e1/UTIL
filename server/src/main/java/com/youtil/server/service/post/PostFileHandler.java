...
//    public PostFileHandler(PostFileService postFileService) {
//
    ...
    public List<PostFile> parseFileInfo(
        ...
        if(!CollectionUtils.isEmpty(multipartFiles)) {
            ...
            for(MultipartFile multipartFile : multipartFiles) {
                ...
                // 파일 DTO 생성
                PostFileDto postFileDto = PostFileDto
                        .builder()
                        .originFileName(multipartFile.getOriginalFilename())
                        .savedFileName(path + File.separator + new_file_name)
...
//                        .post(post)
                ...
                PostFile postFile = new PostFile(
                        postFileDto.getOriginFileName(),
                        postFileDto.getSavedFileName(),
                        postFileDto.getFileSize()
//                        postFileDto.getPost()
                );

                System.out.println(postFileDto.getPost());
